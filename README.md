...
I've opted to use the widescreen Sinden borders, as I found with the non-widescreen versions, there was a kind of distortion affect whereby the accuracy diminishes the closer you aim to an edge (as if lightgun movement matched the lightgun in the centre, but you have to aim wide of the edges to hit the edges), using the wide borders seems to have fixed this for me.
